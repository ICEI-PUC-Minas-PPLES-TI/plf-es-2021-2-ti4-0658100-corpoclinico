...
CREATE TABLE IF NOT EXISTS `corpoclinico`.`medico` (
  ...
  `rg_data_emissao` VARCHAR(45) NULL,
  ...
  `escolaridade_max` ENUM('BACHA', 'ESPE', 'MESTRE', 'DOUTOR') NULL COMMENT 'BACHA = bacharel\nESPE = especialista',
  PRIMARY KEY (`id`),
