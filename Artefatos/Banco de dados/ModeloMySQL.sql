...
CREATE TABLE IF NOT EXISTS `corpoclinico`.`equipe` (
  ...
  INDEX `fk_equipe_usuario1_idx` (`usuario_id` ASC) VISIBLE,
  CONSTRAINT `fk_equipe_especialidade1`
    FOREIGN KEY (`especialidade_id`)
    REFERENCES `corpoclinico`.`especialidade` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_equipe_usuario1`
    FOREIGN KEY (`usuario_id`)
    REFERENCES `corpoclinico`.`usuario` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
...
CREATE TABLE IF NOT EXISTS `corpoclinico`.`medico_especialidade` (
  ...
  `medico_id` INT UNSIGNED NOT NULL,
  `especialidade_id` INT UNSIGNED NOT NULL,
  `arquivos_id` INT UNSIGNED NOT NULL,
  ...
  INDEX `fk_medico_especialidade_arquivos1_idx` (`arquivos_id` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `corpoclinico`.`medico_formacao` (
  ...
  INDEX `fk_medico_formacao_arquivos1_idx` (`arquivos_id` ASC) VISIBLE,
