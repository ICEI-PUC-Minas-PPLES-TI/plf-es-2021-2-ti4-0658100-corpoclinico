<template>
  <v-app class="corpo">
    ...
    >
      <v-row>
        <v-col cols="12" :sm="9">
          <img src="@/assets/logohospital.png" alt="Logo Hospital São Fransisco" width="90px" height="40px">
        </v-col>
        <v-col cols="12" :sm="3">
          <svg width="25" height="23" viewBox="0 0 25 23" fill="none" xmlns="http://www.w3.org/2000/svg" style="margin-top: 10px">
    ...
    <v-container fluid class="corpo-clinico">
      <v-row class="corpo-clinico-header d-none d-md-flex">
        <v-col :md="1">
          <img src="@/assets/logohospital.png" alt="Logo Hospital São Fransisco" width="90px" height="40px" style="float:right">
        </v-col>
        <v-col :md="4">
        ...
        <v-col :md="3" class="corpo-clinico-header-user">
          <v-menu offset-y>
