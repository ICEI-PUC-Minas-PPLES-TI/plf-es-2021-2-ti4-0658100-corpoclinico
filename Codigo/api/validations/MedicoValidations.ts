...
export const medicoUpdateValidationScheme = yup.object().shape({
  crm: yup.string().max(20, "'crm' tamanho máximo de 20 caracteres!").nullable(),

  regiao: yup
    .mixed()
    .oneOf(estados, `'regiao' deve ser algum destes valores: ${estados}!`).nullable(),

  dt_inscricao_crm: yup.date().nullable(),

  celular: yup
    .string()
    .matches(celularRegEx, "'celular' inválido!")
    .max(14, "'celular' tamanho máximo de 14 caracteres!").nullable(),

  cartao_sus: yup
    .string()
    .max(25, "'cartao_sus' tamanho máximo de 25 caracteres!").nullable(),
  ...
  rg: yup.string().max(14, "'rg' tamanho máximo de 14 caracteres!").nullable(),

  rg_orgao_emissor: yup
    .string()
    .max(30, "'rg_orgao_emissor' tamanho máximo de 30 caracteres!").nullable(),
  ...
  cpf: yup
    .string()
    .matches(cpfRegEx, "'cpf' inválido!")
    .max(14, "'cpf' tamanho máximo de 14 caracteres!").nullable(),

  titulo_eleitoral: yup
    .string()
    .min(1, "'titulo_eleitoral' tamanho mínimo de 1 caractere.")
    .max(12, "'titulo_eleitoral' tamanho máximo de 12 caracteres!").nullable(),

  zona: yup.string().max(3, "'zona' tamanho máximo de 3 caracteres!").nullable(),

  secao: yup.string().max(4, "'secao' tamanho máximo de 4 caracteres!").nullable(),

  logradouro: yup
    .string()
    .max(100, "'logradouro' tamanho máximo de 100 caracteres!").nullable(),

  numero: yup.number().nullable(),

  complemento: yup
    .string()
    .max(20, "'complemento' tamanho máximo de 20 caracteres!").nullable(),

  bairro: yup.string().max(45, "'bairro' tamanho máximo de 45 caracteres!").nullable(),

  cidade: yup.string().max(100, "'cidade' tamanho máximo de 100 caracteres!").nullable(),

  estado: yup
    .mixed()
    .oneOf(estados, `'estado' deve ser algum destes valores: ${estados}!`).nullable(),

  cep: yup
    .string()
    .matches(cepRegEx, "'cep' inválido!")
    .max(9, "'cep' tamanho máximo de 9 caracteres!").nullable(),

  sociedade_cientifica: yup
    .string()
    .max(100, "'sociedade_cientifica' tamanho máximo de 100 caracteres!").nullable(),
