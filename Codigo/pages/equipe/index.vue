...
<v-container fluid style="overflow: auto; padding:6vh;">
    <v-card class="mx-auto" width="100%">
        <div class="div-titulo-btn">
            ...
            <v-card-actions>
                <v-btn color="success" background="primary" @click="modalEspecialidadeAtivo = !modalEspecialidadeAtivo">
                    Criar Especialidade
                </v-btn>
            </v-card-actions>
            ...
            <modalEspecialidade v-model="modalEspecialidadeAtivo"> </modalEspecialidade>
            <modalEquipe v-model="modalAtivo" v-bind:equipeId="equipeId"> </modalEquipe>

        </div>
        <v-card-text class="text-h5 ">
            <template>
                <v-data-table :headers="headers" :items="equipes" :items-per-page="5" class="elevation-1">
